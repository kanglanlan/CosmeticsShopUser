...
public final class CrashManager {
    ...
    private static int defaultErrorActivityDrawableId = R.mipmap.logo;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CrashManager.EXTRA_IMAGE_DRAWABLE_ID, R.mipmap.logo);
    }
     ...
     * MySet it to true if you want to launch the error activity when the app is in background,
     ...
     * MySet it to true if you want to show the full stack trace and device info,
     ...
     * MySet this if you want to use an image other than the default one.
     * The default is R.drawable.crashmanager_error_image (a cute upside-down bug).
     */
     ...
     * MySet it to true if you want to show a restart button,
