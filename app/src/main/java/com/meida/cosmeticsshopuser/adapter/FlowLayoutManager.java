...
public class FlowLayoutManager extends RecyclerView.LayoutManager{
    ...
    /*@Override
    public void onMeasure(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State
            state, int widthSpec, int heightSpec) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(widthSpec),heightSize);
    }*/
}
