...
public class GoodsRecyclerAdapter extends CommonAdapter<GoodsItemBean> {

    private Context mContext;

    public GoodsRecyclerAdapter(Context context, int layoutId, List<GoodsItemBean> datas) {
