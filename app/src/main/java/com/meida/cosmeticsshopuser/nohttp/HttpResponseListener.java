...
//    private SVProgressHUD mWaitprogress;
    ...
    public HttpResponseListener(Context context, Request<?> request, HttpListener<T> httpCallback, boolean canCancel, boolean isLoading) {
        ...
        if (context != null && isLoading) {
            mWaitDialog = new CustomDialog(context, R.style.CustomDialog);
            mWaitDialog.setContentView(R.layout.dialog_custom);
...
//            mWaitprogress = new SVProgressHUD(context);
        }
...
//            mWaitDialog.show();
    ...
    public void onFinish(int what) {
        try {
            if (isLoading && mWaitDialog != null && mWaitDialog.isShowing())
                mWaitDialog.dismiss();
//            if (isLoading && mWaitprogress != null && mWaitprogress.isShowing())
