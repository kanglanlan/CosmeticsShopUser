...
public class LineView  extends View {
     ...
     * 纵坐标固定值分为几个间隔 默认6个
     */
    private int yGapSize = 5;
    /**
     * 背景色
     */
    private int bgColor = 0x66ffffff;
    /**
     * 刻度值字体大小
     */
     ...
     * 刻度字体颜色
     */
    private int scaleTxtColor = 0xff000000;
    /**
     * 折线颜色
     */
    private int lineColor = 0xffFF6D0C;
    /**
     * 折线粗细层度
     */
     ...
     * 外圈颜色
     */
    private int outCircleColor =0xffFF6D0C;
    /**
     * 内圈颜色
     */
    private int innCircleColor =0xffFF6D0C;
    ...
    private void initPaint() {
        ...
        DOT_INNER_CIR_RADIUS = dp2px(this.getContext(), 1.0F);
        DOT_OUTER_CIR_RADIUS = dp2px(this.getContext(), 1.0F);
