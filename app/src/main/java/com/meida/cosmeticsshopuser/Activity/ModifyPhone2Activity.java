...
public class ModifyPhone2Activity extends BaseActivity {
    ...
    private void initView(){
        ...
        TextView currPhone = (TextView)findViewById(R.id.currPhone);
        String phoneStr = PreferencesUtils.getString(baseContext, Params.KEY_PHONE);
        currPhone.setText(String.format("%s%s", getResources().getString(R.string.tip_changePhone2), phoneStr));
    ...
    /*修改手机号*/
    private void modifyUserPhone(final String mobile){
        mRequest03 = getRequest(Params.modifyPhone,true);
        mRequest03.add("mobile",mobile);
                ...
                new CustomHttpListener<ActionBean>(baseContext,true,ActionBean.class) {
                    ...
                    public void doWork(ActionBean result, String code) {
                        try{
                            ...
                            PreferencesUtils.putString(baseContext,Params.KEY_PHONE,mobile);
